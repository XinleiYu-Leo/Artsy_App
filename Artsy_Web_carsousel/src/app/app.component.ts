...
export class AppComponent {
  ...
  display_c0: string = "carousel-item active";
  display_c1: string = "";
  display_c2: string = "";
  display_c3: string = "";
  display_c4: string = "";
  ...
  onSubmit(search:NgForm){
    ...
    this.container_sty ="display:block; width:79%; margin-left:10.5%";
